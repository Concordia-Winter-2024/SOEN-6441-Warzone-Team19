...
public class BombTest {
	...
	public void testExecuteOrder2() {
		...
		assertEquals("Player \"Shubham\" bombed country \"2\" successfully.", l_bombCmd.execute(d_game));
	}
	...
	public void testExecuteOrder3() {
		Bomb l_bombCmd = new Bomb(d_game.d_players.get("Shubham"), 1);
		assertEquals("Player \"Shubham\" doesn't have bomb card.", l_bombCmd.execute(d_game));
	}
