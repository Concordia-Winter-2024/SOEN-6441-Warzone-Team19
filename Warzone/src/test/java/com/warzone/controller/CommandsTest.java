...
public class CommandsTest {
    ...
    public static void beforeAll() {
        System.out.println("Starting test cases for Commands class");
    }
    @AfterAll
    public static void afterAll() {
        System.out.println("Completed test cases for Commands class");
    }
    /**
    ...
    public void testLoadMap() {
        ...
        String[] l_loadCommand2 = new String[] { "loadmap", "map_which_does_not_exist.map" };
        String l_loadResultString2 = d_commands.executeCommand(l_loadCommand2);
        assertEquals("Map \"map_which_does_not_exist\" cannot be loaded", l_loadResultString2);

        String[] l_loadCommand3 = new String[] { "loadmap", "map_which_does_not_exist" };
    ...
    public void testEditContinent() {
        String[] l_loadCommand1 = new String[] { "editmap", "TestMap.map" };
        String l_loadResultString1 = d_commands.executeCommand(l_loadCommand1);
    ...
    public void testEditMap() {
        ...
        String[] l_loadCommand2 = new String[] { "editmap", "TestMap" };
        ...
        String[] l_loadCommand3 = new String[] { "editmap", "TestMap.map" };
    ...
    public void testSaveMap() {
        String[] l_loadCommand1 = new String[] { "editmap", "TestMapSave.map" };
        String l_loadResultString1 = d_commands.executeCommand(l_loadCommand1);

        String[] l_saveCommand1 = new String[] { "savemap", "TestMapSave.map" };
        ...
        String[] l_saveCommand2 = new String[] { "savemap", "TestMapSave" };
